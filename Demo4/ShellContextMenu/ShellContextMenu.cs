...
namespace Demo4
{
    ...
    public class ShellContextMenu : NativeWindow
    {
        ...
        public void ShowContextMenu(FileInfo[] files, DirectoryInfo[] dirs, Point pointScreen)
        {
            // Release all resources first.
            ReleaseAll();
            IntPtr[] array1 = GetPIDLs(dirs);
            IntPtr[] array2 = GetPIDLs(files);
            if (array1 == null)
            {
                _arrPIDLs = array2;
            }
            ...
            {
                _arrPIDLs = new IntPtr[array1.Length + array2.Length];
                Array.Copy(array1, _arrPIDLs, array1.Length);
                Array.Copy(array2, 0, _arrPIDLs, array1.Length, array2.Length);
            }
